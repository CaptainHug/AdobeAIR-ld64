...
//[Adobe Changes]
#ifdef WIN_LD64
	uint8_t* p = (uint8_t*)::mmap_win(info.path, 0);
#else
...
//[Adobe Changes]
	...
	if ( objResult != NULL ) {
		...
		OSAtomicAdd32(  1, &_totalObjectLoaded);
		return objResult;
	}
...
//[Adobe Changes]
	...
	if ( archiveResult != NULL ) {
		...
		/* Bug:4086086 - Change done to avoid dependency on OSX 10.10 */
        //Adobe Changes
		//OSAtomicIncrement32(&_totalArchivesLoaded);
		OSAtomicAdd32(  1, &_totalArchivesLoaded);
