...
template <typename T>
#ifndef WIN_LD64		//[Adobe Changes]
	unsigned long myalignof() { struct { char c; T t; } s; return sizeof(s) - sizeof(T); }
#else
	unsigned long myalignof1() { struct { char c; T t; } s; return sizeof(s) - sizeof(T); }
#endif
//template <typename T>
