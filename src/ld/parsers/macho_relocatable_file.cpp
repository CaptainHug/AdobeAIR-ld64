			...
			switch (platform) {
				...
				case Options::kPlatformiOS:
					if ( lcPlatform == Options::kPlatformUnknown )
						break;
					//[Adobe changes]
					if ( simulator && lcPlatform == Options::kPlatformOSX ) {
						break;
					}
...
#ifdef WIN_LD64
template <>
void mach_o::relocatable::CFISection<x86_64>::cfiParse(mach_o::relocatable::Parser<x86_64>&, unsigned char*, libunwind::CFI_Atom_Info<mach_o::relocatable::CFISection<x86_64>::OAS>*, unsigned int&, unsigned long long const*, unsigned int)
{
}

template <>
void mach_o::relocatable::CFISection<x86>::cfiParse(mach_o::relocatable::Parser<x86>&, unsigned char*, libunwind::CFI_Atom_Info<mach_o::relocatable::CFISection<x86>::OAS>*, unsigned int&, unsigned int const*, unsigned int)
{
}

template <> 
void mach_o::relocatable::CFISection<arm64>::cfiParse(mach_o::relocatable::Parser<arm64>&, unsigned char*, libunwind::CFI_Atom_Info<mach_o::relocatable::CFISection<arm64>::OAS>*, unsigned int&, unsigned long long const*, unsigned int)		
{
}
								
template <>
void mach_o::relocatable::CFISection<arm>::cfiParse(mach_o::relocatable::Parser<arm>& parser, uint8_t* buffer, 
									libunwind::CFI_Atom_Info<mach_o::relocatable::CFISection<arm>::OAS>*, 
